import re,os,shutil,smtplib
from email.MIMEMultipart import MIMEMultipart
from email.MIMEText import MIMEText

############## CONFIG ############################################# 
dlfolder = '<yourfolder>' ### 
moviefolder = '<folder for your movies>' ### 
seriefolder = '<folder for your series' ### 
videoregex = '\.mkv|\.iso' #you can add with | \.<new ending> ###
cancelregex = '\.mp3|\.wave|\.flac|\.cue|\.m3u|\.msi|\.dll|\.exe' #you can add with |\.<new ending> ###
mailtext = ""
###################################################################
...
if(video == None): #no video content -> please delete oldpath = os.path.join(path,file)
...
#MOVE MOVIES / SERIES
try:
print "Start: moveContent: " + dlfolder
...
#check if folder is empty to delete
try:
print "Start: removeEmptyFolders"
removeEmptyFolders(dlfolder)
except Exception as erro:
print erro.message
mailtext = mailtext + erro.message
#create new ToMove folder if not exists
